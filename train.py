...
import datasets.lasted_trainset
import datasets.genimage
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config-file", type=str, default="configs/trainers/CoOp/genimage.yaml", help="path to config file"
    )
    parser.add_argument(
        "--dataset-config-file",
        type=str,
        default="configs/datasets/genimage.yaml",
    ...
    parser.add_argument(
        "--model-dir",
        type=str,
        default="output/ViT-L-14/CoOp/GenImage/nctx16_cscTrue_ctpend/seed1",
    ...
    parser.add_argument(
        "--no-train", action="store_true", default=True, help="do not call trainer.train()"
    )
    parser.add_argument(
        "opts",
        default=None,
    ...
    args.output_dir = "output/ViT-L-14/CoOp/GenImage/nctx16_cscTrue_ctpend/seed1"
    main(args)
